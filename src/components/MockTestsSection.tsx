...
import { Clock, HelpCircle, Award, Target, Play, RotateCcw, CheckCircle, X } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Practice tests to improve your skills</p>
          {!isPremium && (
            <p className="text-sm text-orange-600 mt-1">
              🔒 Upgrade to Premium to access all mock tests
            </p>
          )}
        </div>
